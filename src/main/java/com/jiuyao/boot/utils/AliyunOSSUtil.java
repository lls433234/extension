...
import com.jiuyao.boot.config.AliyunOSSConfigConstant;
...
//        String dateString = sdf.format(new Date()) + "." + suffix; // 20180322010634.jpg
        String dateString = file.getName()+ "." + suffix; // 20180322010634.jpg
...
//        getUrl("product/class/26065946787446951.jpg");
        List<String> document = listFile("document");
        System.out.println(document);
//        fileFolder(null);
//        fileFolder("document");
//        String bucketUrl = "
//https://chongqingjiuyao.oss-cn-chengdu.aliyuncs.com";
